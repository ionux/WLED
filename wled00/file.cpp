...
{
  if ((file == nullptr) || (key == nullptr) || (content == nullptr))
  {
    return false;
  }
...
{
  if ((file == nullptr) || (key == nullptr) || (dest == nullptr))
  {
    return false;
  }
